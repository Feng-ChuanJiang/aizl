							...
							<thead>
								...
								<tr class="second">
									<td><label class="input"> <input type="text"
											name="search_engine" value="Filter engines"
											class="search_init">
									</label></td>
									<td><label class="input"> <input type="text"
											name="search_browser" value="Filter browsers"
											class="search_init">
									</label></td>
									<td><label class="input"> <input type="text"
											name="search_platform" value="Filter platforms"
											class="search_init">
									</label></td>
									<td><label class="input"> <input type="text"
											name="search_version" value="Filter versions"
											class="search_init">
									</label></td>
									<td><label class="input"> <input type="text"
											name="search_grade" value="Filter grades" class="search_init">
									</label></td>
								</tr>
							</thead>
							<tbody>
