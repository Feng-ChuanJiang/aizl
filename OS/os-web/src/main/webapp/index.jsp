...
<body class="">
		...
		<div class="pull-right">
			...
			<ul class="header-dropdown-list hidden-xs">
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<img alt="" src="img/flags/us.png"> <span> US </span> <i
						class="fa fa-angle-down"></i>
				</a>
					<ul class="dropdown-menu pull-right">
						<li class="active"><a href="javascript:void(0);"><img
								alt="" src="img/flags/us.png"> US</a></li>
						<li><a href="javascript:void(0);"><img alt=""
								src="img/flags/es.png"> Spanish</a></li>
						<li><a href="javascript:void(0);"><img alt=""
								src="img/flags/de.png"> German</a></li>
					</ul></li>
			</ul>
			<!-- end multiple lang -->
	...
	<aside id="left-panel">
		...
		<nav>
			...
			<ul>
				<li><a href="index.html" title="您的主要工作"><i
						class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">主面板</span></a>
				</li>
				<li><a href="inbox.html"><i class="fa fa-lg fa-fw fa-inbox"></i>
						<span class="menu-item-parent">邮件</span><span
						class="badge pull-right inbox-badge">2</span></a></li>
				<li><a href="#"><i class="fa fa-lg fa-fw fa-bar-chart-o"></i>
						<span class="menu-item-parent">数据统计</span></a>
					<ul>
						<li><a href="flot.html">服务器</a></li>
						<li><a href="morris.html">数据库</a></li>
						<li><a href="inline-charts.html">app应用</a></li>
					</ul></li>
				<li><a href="#"><i class="fa fa-lg fa-fw fa-table"></i> <span
						class="menu-item-parent">数据管理</span></a>
					<ul>
						<li class="active"><a href="javaScript:void(0);">权限</a></li>
						<li><a href="datatables.html">菜单、控件</a></li>
					</ul></li>
				<li><a href="#"><i
	...
	<script src="<%=path%>/js/plugin/datatables/jquery.dataTables-cust.min.js"></script>
	<script src="<%=path%>/js/plugin/datatables/ColReorder.min.js"></script>
	<script src="<%=path%>/js/plugin/datatables/FixedColumns.min.js"></script>
	<script src="<%=path%>/js/plugin/datatables/ColVis.min.js"></script>
	<script src="<%=path%>/js/plugin/datatables/ZeroClipboard.js"></script>
	<script src="<%=path%>/js/plugin/datatables/media/js/TableTools.min.js"></script>
